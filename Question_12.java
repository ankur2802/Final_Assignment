...
public class Question_12 {
    ...
    private static final String DB_PASSWORD = "ankur@12";
    ...
    public static void main(String[] args) {
        try {
            ...
            // Insert a record
            int recordId = insertRecord(conn, "krishna kumar", "krishna@gmail.com");

            // Display all records
            displayAllRecords(conn);

            // Update the inserted record
            updateRecord(conn, recordId, "Rani Kumari", "rani@gmail.com");
